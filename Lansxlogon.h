...
#ifndef __LANSXLOGON_H__
#define  __LANSXLOGON_H__ 1
...
public:
    ...
    static void FormatLine(TAttLine* attl,int col=2,int sty=1,int w=2)
    {
    ...
    static void FormatMarker(TAttMarker* attm,int col=2,int sty=20,int size=1,double alpha=1.)
    {
    ...
    static void FormatFill(TAttFill* attfill,int col=2,int sty=3005)
    {
    ...
    //FormatAll
    static void FormatAll(TObject* obj,const char*fmt,...)
    {
        //fmt 
    ...
    static void InsertLogo(TCanvas* can,int padid,double xlow=0.12,double ylow=0.82,double xup=0.36,double yup=1.0)
    {
        //read the cepc logo 
